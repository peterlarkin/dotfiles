...
defaults write NSGlobalDomain AppleHighlightColor -string "0.651 0.980 0.992"
...
# Use a modified version of the One Dark theme by default in Terminal.app
osascript <<EOD
...
open "${HOME}/.dotfiles/themes/One Dark.itermcolors"
